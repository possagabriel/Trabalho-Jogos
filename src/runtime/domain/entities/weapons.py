...
class Projetil:
    ...
    def desenhar(self, tela: pygame.Surface) -> None:
        ...
        if self.tipo == "plasma":
            ...
            for sinal in (-1, 1):
                from src.runtime.infrastructure.graphics.cel_shading import contorno_poligono
