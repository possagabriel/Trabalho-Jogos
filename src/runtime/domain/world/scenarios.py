...
def _superficie_alpha(raio, cor):
    ...
    """
    from src.runtime.infrastructure.graphics.smooth import luz_radial
...
def _imagem_fundo(cenario_id=None):
    """Carrega o fundo do cenario no canvas logico e o cacheia.
...
class Cenario:
    ...
    def _criar_gradiente(self, topo, base):
        from src.runtime.infrastructure.graphics.smooth import gradiente_vertical
